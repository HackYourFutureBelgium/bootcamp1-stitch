  ...
  function StitchRequestItem({stitchNotification, decline, accept}) { 
    ...
    return (
      <Card style={{ width: 600, border:'none'}}>
       ...
       <h2 className="notification-type" style={{color:'#002766',textTransform:'capitalize', margin: '10px 0px'}}>Stitch request from {name}</h2>
       <h3 className="notification-role" style={{color:'#002766', textTransform:'capitalize', margin: '10px 0px'}}>{role}</h3>
       <h3 className="notification-stitch" style={{color:'#002766', margin: '10px 0px'}}>{stitch}</h3>
